...
function inputTypeRouter(inputType: string, inputValue: string) {
  switch (inputType) {
    case "text":
      return emptyFieldValidation(inputValue)
    case "password":
      return passwordValidation(inputValue)
    case "email":
      return emailValidation(inputValue)
  }
}

export{inputTypeRouter};